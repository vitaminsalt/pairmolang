...
function timeFunc() {
    ...
    if (min == 0) {
        ...
        document.getElementById("clock").innerHTML = min + ':' + sec + "." + milli;
        document.getElementById("paused-time").innerHTML = min + ':' + sec + "." + milli;
        document.getElementById("done-time").innerHTML = min + ':' + sec + "." + milli;
    }
